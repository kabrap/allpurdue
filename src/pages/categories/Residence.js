    ...
    useEffect(() => {
      async function fetchData() {
        try {
          ...
          const filteredPlaces = response.data.filter(place => place.placeType === "Living");
    ...
    return (
        <div>
          ...
          <div className='sorting-container'>
            <span id='all-places'><a className='link-back' href='/categories'>All Places</a> {'>'} Residence Halls</span>
