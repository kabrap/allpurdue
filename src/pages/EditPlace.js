...
function EditPlace() {
    ...
    return (
        <div className="edit-location-container">
            <h2 className="edit-location-title">Edit a Location</h2>
            <form id='forgot-form' className="edit-location-form" onSubmit={handleSubmit}>
              <div className="type-bar">
                {placeType === "Food" &&
                  <button id='left-type' className='edit-location-clicked-button' onClick={() => handlePlaceType("Food")}>Food</button>
                }
                {placeType !== "Food" &&
                  <button id='left-type' className='edit-location-type-button' onClick={() => handlePlaceType("Food")}>Food</button>
                }
                {placeType === "Cafe" &&
                  <button className='edit-location-clicked-button' onClick={() => handlePlaceType("Cafe")}>Cafe</button>
                }
                {placeType !== "Cafe" &&
                  <button className='edit-location-type-button' onClick={() => handlePlaceType("Cafe")}>Cafe</button>
                }
                {placeType === "Study" &&
                  <button className='edit-location-clicked-button'onClick={() => handlePlaceType("Study")}>Study</button>
                }
                {placeType !== "Study" &&
                  <button className='edit-location-type-button'onClick={() => handlePlaceType("Study")}>Study</button>
                }
                {placeType === "Living" &&
                  <button id='right-type' className='edit-location-clicked-button'onClick={() => handlePlaceType("Living")}>Living</button>
                }
                {placeType !== "Living" &&
                  <button id='right-type' className='edit-location-type-button'onClick={() => handlePlaceType("Living")}>Living</button>
                }
              </div>
              <label className='edit-location-field-container'>
